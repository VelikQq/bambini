<?php  //[STAMP] 10a97244321bcf5f9934f62fadf29ada
...
trait AcceptanceTesterActions
{
     ...
     * @throws Exception
     * @see \Helper\Shot::makeFullScreen()
     */
    public function makeFullScreen($testName) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('makeFullScreen', func_get_args()));
    }
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Using get_file_contents in the context of http / 1.1.
     *
     * @param $filename
     * @return string
     * @throws Exception
     * @see \Helper\System::getFileContents()
     */
    public function getFileContents($filename): string {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getFileContents', func_get_args()));
    }
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Change permission / prohibition on browser notifications.
     *
     * @param int $status
     * @throws Exception
     * @see \Helper\System::editNotificationsStatus()
     */
    public function editNotificationsStatus($status) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('editNotificationsStatus', func_get_args()));
    }
     ...
     * @return string color
     * @throws Exception
     * @see \Helper\System::getElementColor()
     */
    public function getElementColor($path): string {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getElementColor', func_get_args()));
    }
     ...
     * @param string $color
     * @return string
     * @see \Helper\System::rgbaToHex()
     */
    public function rgbaToHex($color): string {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('rgbaToHex', func_get_args()));
    }
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Construct an image hash from a file.
     *
     * @param string $imageFile
     * @param integer $pHashSizeRoot The square root of the hash size. 4 and more. The more, the more accurate the comparison.
     * @param integer $pHashDetalization hash detail, from 2 to 6. The more - the more accurate the comparison.
     * @param boolean $toBase64 Convert the result to base64?
     * @return string hash image
     * @throws Exception
     * @see \Helper\System::createHashFromFile()
     */
    public function createHashFromFile($imageFile, $pHashSizeRoot = 10, $pHashDetalization = 3, $toBase64 = true): string {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('createHashFromFile', func_get_args()));
    }
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Construct an image hash from a string containing the contents of the loaded image file.
     *
     * @param string $imageFileContents
     * @param integer $pHashSizeRoot The square root of the hash size. 4 and more. The more, the more accurate the comparison.
     * @param integer $pHashDetalization hash detail, from 2 to 6. The more - the more accurate the comparison.
     * @param boolean $toBase64 Convert the result to base64?
     * @return string hash image
     * @throws Exception
     * @see \Helper\System::createHashFromFileContents()
     */
    public function createHashFromFileContents($imageFileContents, $pHashSizeRoot = 10, $pHashDetalization = 3, $toBase64 = true): string {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('createHashFromFileContents', func_get_args()));
    }
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Construct an image hash to quickly compare the similarity of images.
     * Allows you to quickly determine the similarity of images that are one
     * and the same image, but, for example, with resized and proportioned,
     * or with slightly corrected colors.
     *
     ...
     * @throws Exception
     * @see \Helper\System::createHash()
     */
    public function createHash($image, $pHashSizeRoot = 10, $pHashDetalization = 3, $toBase64 = true): string {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('createHash', func_get_args()));
    }
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Compare two hashes of images.
     *
     * @param string $hash1 hash of the first image in base64 format
     * @param string $hash2 hash of the second image in the same format
     * @param float $epsilon Maximum relative error. 1 is 100%, 0.5 is 50%, and so on.
     * @param int $error Reference to the variable into which the error value will be written (a number from 0 to 1)
     * @param boolean $base64decoded Flag indicating that the passed hashes are already base64 decoded
     * @return boolean returns true / false depending on whether the hashes match
     * @see \Helper\System::compareImageHashes()
     */
    public function compareImageHashes($hash1, $hash2, $epsilon = 0.01, $error = 0, $base64decoded = false): bool {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('compareImageHashes', func_get_args()));
    }
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Comparison of pictures by hash.
     *
     * @param mixed $firstImage first captcha
     * @param mixed $secondImage second captcha
     * @param bool $equals false - compare for inequality
     * @throws Exception
     * @see \Helper\System::compareImages()
     */
    public function compareImages($firstImage, $secondImage, $equals = true) {
     ...
     * @throws Exception
     * @see \Helper\System::getNumberOfElements()
     */
    public function getNumberOfElements($path, $linkDescription = NULL): int {
     ...
     * @param string $elemDescription element description
     * @param string $noScroll disable scrolling to the element
     * @throws Exception
     * @see \Helper\System::waitAndClick()
     */
    public function waitAndClick($path, $elemDescription, $noScroll = NULL) {
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Wait for element visible with correct message.
     *
     * @param mixed $path element reference
     * @param string $elemDescription element description
     * @param int $wait
     * @throws Exception
     * @see \Helper\System::waitForVisible()
     */
    public function waitForVisible($path, $elemDescription, $wait = 30) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('waitForVisible', func_get_args()));
    }
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Wait for element not visible with correct message.
     *
     * @param mixed $path element reference
     * @param string $elemDescription element description
     * @param int $wait
     * @throws Exception
     * @see \Helper\System::waitForNotVisible()
     */
    public function waitForNotVisible($path, $elemDescription, $wait = 30) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('waitForNotVisible', func_get_args()));
    }
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Screenshot and crop image from screenshot.
     *
     * @param string $imageXpath
     * @param string $imgName
     * @return string screen path
     * @throws Exception
     * @see \Helper\System::screenAndCropImage()
     */
    public function screenAndCropImage($imageXpath, $imgName): string {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('screenAndCropImage', func_get_args()));
    }
     ...
     *
     * @param string $firstStr first line
     * @param string $secondStr second line
     * @return bool true \ false line match
     * @see \Helper\System::compareStrings()
     */
    public function compareStrings($firstStr, $secondStr): bool {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('compareStrings', func_get_args()));
    }
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Getting the dimensions of the page element.
     *
     * @param string $path path to the element
     * @return array page element size
     * @throws Exception
     * @see \Helper\System::findSizeByXpath()
     */
    public function findSizeByXpath($path): array {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('findSizeByXpath', func_get_args()));
    }
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     *Getting the coordinates of the page element.
     *
     * @param string $path path to the element
     * @return array coordinates of the page element
     * @throws Exception
     * @see \Helper\System::findLocationByXpath()
     */
    public function findLocationByXpath($path): array {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('findLocationByXpath', func_get_args()));
    }
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Calculation of the position of the element in the screenshot.
     *
     * @param array $location position of the element on the page
     * @param int $screenHeight screenshot height
     * @return array position of the element in the screenshot
     * @throws Exception
     * @see \Helper\System::getNewLocation()
     */
    public function getNewLocation($location, $screenHeight): array {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getNewLocation', func_get_args()));
    }
     ...
     *
     * @return mixed browser logs
     * @throws Exception
     * @see \Helper\System::getJsLog()
     */
     ...
     * @throws Exception
     * @see \Helper\System::getConfigUrl()
     */
    public function getConfigUrl(): string {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getConfigUrl', func_get_args()));
    }
     ...
     * @return bool|string page content
     * @see \Helper\System::urlGetContent()
     */
    public function urlGetContent($url) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('urlGetContent', func_get_args()));
    }
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Determination of the current URL.
     *
     * @return string current url
     * @throws Exception
     * @see \Helper\System::getFullUrl()
     */
    public function getFullUrl(): string {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getFullUrl', func_get_args()));
    }
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Changing the user-agent in the WebDriver module.
     *
     * @param string $userAgent
     * @throws Exception
     * @see \Helper\System::editUserAgent()
     */
    public function editUserAgent($userAgent) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('editUserAgent', func_get_args()));
    }
     ...
     *
     * @return Cookie[]|null page cookie
     * @throws Exception
     * @see \Helper\System::getCurrentCookie()
     */
    public function getCurrentCookie(): ?array {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getCurrentCookie', func_get_args()));
    }
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Environment definition - production site or test container.
     *
     * @return bool true \ false depends on prod or stage
     * @throws Exception
     * @see \Helper\System::isProduction()
     */
    public function isProduction(): bool {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('isProduction', func_get_args()));
    }
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Check for the presence of the specified element on the page.
     *
     * @param mixed $path element link
     * @param string $elemDescription Item description
     * @throws Exception
     * @see \Helper\System::checkElementOnPage()
     */
    public function checkElementOnPage($path, $elemDescription = NULL) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('checkElementOnPage', func_get_args()));
    }
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Generation of a random string, the number of digits in a string is set by the parameter.
     *
     * @param string $length Number of digits in the resulting string
     * @return string generated string
     * @see \Helper\System::generateString()
     */
    public function generateString($length = NULL): string {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('generateString', func_get_args()));
    }
     ...
     *
     * @see \Helper\System::unFocus()
     */
    public function unFocus() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('unFocus', func_get_args()));
    }
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Filtering browser logs.
     *
     * @param array $array array of the browser log
     * @param string $level error level
     * @param array $sortMessages the desired message / s
     * @return array an array with bool in first position and error messages
     * @throws Exception
     * @see \Helper\System::filterBrowserLogs()
     */
    public function filterBrowserLogs(array $array, $level, $sortMessages): array {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('filterBrowserLogs', func_get_args()));
    }
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Parsing and filtering browser logs for errors.
     *
     * @param string $level error level
     * @param array $sortMessages the desired message / s in the logs
     * @param string $errorMessage message when an error is encountered
     * @throws Exception
     * @see \Helper\System::seeBrowserLogs()
     */
    public function seeBrowserLogs($level, $sortMessages, $errorMessage) {
        return $this->getScenario()->runStep(new \Codeception\Step\Assertion('seeBrowserLogs', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     ...
     * @see \Helper\System::seeBrowserLogs()
     */
    public function canSeeBrowserLogs($level, $sortMessages, $errorMessage) {
        return $this->getScenario()->runStep(new \Codeception\Step\ConditionalAssertion('seeBrowserLogs', func_get_args()));
    }
     ...
     * @throws Exception
     * @see \Helper\System::getElementSize()
     */
    public function getElementSize($selector): array {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getElementSize', func_get_args()));
    }
     ...
     *
     * @param string $paramUrl extension address
     * @throws Exception
     * @see \Helper\System::checkResponseCode()
     */
    public function checkResponseCode($paramUrl = "") {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('checkResponseCode', func_get_args()));
    }
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Determination of the current time - hours.
     *
     * @return string current hour
     * @see \Helper\System::currentHour()
     */
    public function currentHour(): string {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('currentHour', func_get_args()));
    }
     ...
     * @throws Exception
     * @see \Helper\System::waitAndFill()
     */
    public function waitAndFill($link, $description, $data, $noScroll = NULL) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('waitAndFill', func_get_args()));
    }
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Complete cleaning of the input field.
     *
     * @param mixed $path input field
     * @throws Exception
     * @see \Helper\System::clearFieldWithAttribute()
     */
    public function clearFieldWithAttribute($path) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('clearFieldWithAttribute', func_get_args()));
    }
     ...
     * @return string
     * @throws Exception
     * @see \Helper\System::getNumberFromLink()
     */
    public function getNumberFromLink($link, $linkDescription) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getNumberFromLink', func_get_args()));
    }
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Get and sort all https requests.
     *
     * @param string $needle
     * @return array $requests
     * @throws Exception
     * @see \Helper\System::getRequests()
     */
    public function getRequests($needle = NULL): array {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getRequests', func_get_args()));
    }
     ...
     * @throws Exception
     * @see \Helper\System::getSessionID()
     */
    public function getSessionID(): ?string {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getSessionID', func_get_args()));
    }
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Reconfiguration REST module.
     *
     * @param string $db
     * @return mixed
     * @throws Exception
     * @see \Helper\QaApi::reconfRest()
     */
    public function reconfRest($db) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('reconfRest', func_get_args()));
    }
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Get vouchers exclusions for manufacturers.
     *
     * @param string $code voucher name
     * @return array manufacturers
     * @throws Exception
     * @see \Helper\QaApi::getVouchersExclusions()
     */
    public function getVouchersExclusions($code = NULL, $db = ""): array {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getVouchersExclusions', func_get_args()));
    }
     ...
     *
     * @param string $sum voucher amount
     * @return string voucher
     * @throws Exception
     * @see \Helper\QaApi::generateFixedAmountVoucher()
     */
    public function generateFixedAmountVoucher($sum, $db = ""): string {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('generateFixedAmountVoucher', func_get_args()));
    }
     ...
     *
     * @param string $percent voucher amount
     * @param bool $promotion
     * @return string voucher
     * @throws Exception
     * @see \Helper\QaApi::generatePercentageVoucher()
     */
    public function generatePercentageVoucher($percent, $db = "", $promotion = true): string {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('generatePercentageVoucher', func_get_args()));
    }
     ...
     * @throws Exception
     * @see \Helper\QaApi::getDDPCountries()
     */
    public function getDDPCountries($db = ""): string {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getDDPCountries', func_get_args()));
    }
     ...
     * @return mixed
     * @throws Exception
     * @see \Helper\QaApi::toggleVoucherActivity()
     */
    public function toggleVoucherActivity($voucher, $db = "") {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('toggleVoucherActivity', func_get_args()));
    }
     ...
     * @throws Exception
     * @see \Helper\QaApi::deleteUserByMail()
     */
    public function deleteUserByMail($userMail, $db = "") {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('deleteUserByMail', func_get_args()));
    }
     ...
     * @throws Exception
     * @see \Helper\QaApi::getUnsubscribeLink()
     */
    public function getUnsubscribeLink($userMail, $subscriptionType, $db = ""): string {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getUnsubscribeLink', func_get_args()));
    }
     ...
     *
     * @return array restriction zones data
     * @throws Exception
     * @see \Helper\QaApi::getRestrictionZones()
     */
    public function getRestrictionZones($db = ""): array {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getRestrictionZones', func_get_args()));
    }
     ...
     * @throws Exception
     * @see \Helper\QaApi::getTagProducts()
     */
    public function getTagProducts($tag, $db = ""): array {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getTagProducts', func_get_args()));
    }
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Get country free delivery limits.
     *
     * @param string $country Iso code
     * @param string $currency Iso code
     * @param string $language Iso code
     * @return string free delivery limits
     * @throws Exception
     * @see \Helper\QaApi::getCountryDeliveryLimits()
     */
    public function getCountryDeliveryLimits($country = "", $currency = "", $language = "en"): string {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getCountryDeliveryLimits', func_get_args()));
    }
}
